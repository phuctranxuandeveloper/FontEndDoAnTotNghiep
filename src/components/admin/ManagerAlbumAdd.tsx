...
import { getArtists, getListSongByArtist, getSingleArtist } from "../../server/ArtistService";
import toast from "react-hot-toast";
import { createAlbum } from "../../server/AlbumService";
import { Artist } from "../../models/Artist";
import { Album } from "../../models/Album";
import { Song } from "../../models/Song";

export const ManagerAlbumAdd = () => {
  ...
  const handleSave = () => {
    if (album !== null) {
      ...
      album.releaseDate = releaseDateInput;
      album.songs = listSongSelected;
      getSingleArtist(selectedOption)
        .then((data) => {
          album.artist = data;
          toast.promise(createAlbum(album), {
            loading: "Saving.....",
  ...
  useEffect(() => {
    if (album) {
      ...
      setReleaseDateInput(album.releaseDate);
